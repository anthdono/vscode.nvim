...
theme.set_highlights = function(opts)
    ...
    hl(0, '@conditional', { fg = c.vscPink, bg = 'NONE', bold = true })
    hl(0, '@repeat', { fg = c.vscPink, bg = 'NONE', bold = true })
    hl(0, '@label', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@keyword', { fg = c.vscBlue, bg = 'NONE', bold = true })
    hl(0, '@keyword.function', { fg = c.vscBlue, bg = 'NONE', bold = true })
    hl(0, '@keyword.operator', { fg = c.vscBlue, bg = 'NONE', bold = true })
    hl(0, '@keyword.return', { fg = c.vscBlue, bg = 'NONE', bold = true })
    hl(0, '@operator', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@exception', { fg = c.vscPink, bg = 'NONE', bold = true })
    hl(0, '@type', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, '@type.builtin', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@structure', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@include', { fg = c.vscBlue, bg = 'NONE', bold = true })
    ...
    -- Gitgutter
    hl(0, 'GitGutterAdd', { fg = c.vscGitAdded, bg = 'NONE' })
    hl(0, 'GitGutterChange', { fg = c.vscGitModified, bg = 'NONE' })
    hl(0, 'GitGutterDelete', { fg = c.vscGitDeleted, bg = 'NONE' })
    ...
    hl(0, 'CmpItemKindInterface', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'CmpItemKindText', { fg = c.vscYellowOrange, bg = 'NONE' })
    hl(0, 'CmpItemKindFunction', { fg = c.vscYellow, bg = 'NONE' })
    hl(0, 'CmpItemKindMethod', { fg = c.vscYellow, bg = 'NONE' })
    hl(0, 'CmpItemKindKeyword', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'CmpItemKindClass', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'CmpItemKindProperty', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, 'CmpItemKindUnit', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'CmpItemKindConstructor', { fg = c.vscYellow, bg = 'NONE' })
    ...
    hl(0, 'CompeDocumentation', { fg = c.vscViolet })
    hl(0, 'CompeDocumentationBorder', { fg = c.vscViolet })
    hl(0, 'CmpItemKind', { fg = c.vscViolet })
    hl(0, 'CmpItemKindClass', { fg = c.vscBlueGreen })
    hl(0, 'CmpItemKindModule', { fg = c.vscBlueGreen })
    hl(0, 'CmpItemKindOperator', { fg = c.vscViolet })
    hl(0, 'CmpItemKindReference', { fg = c.vscViolet })
    hl(0, 'CmpItemKindValue', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, 'CmpItemKindField', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, 'CmpItemKindEnum', { fg = c.vscViolet })
    hl(0, 'CmpItemKindSnippet', { fg = c.vscViolet })
    hl(0, 'CmpItemKindColor', { fg = c.vscViolet })
    hl(0, 'CmpItemKindFile', { fg = c.vscViolet })
    hl(0, 'CmpItemKindFolder', { fg = c.vscViolet })
    hl(0, 'CmpItemKindEvent', { fg = c.vscViolet })
    hl(0, 'CmpItemKindEnum', { fg = c.vscBlueGreen })
    hl(0, 'CmpItemKindEnumMember', { fg = c.vscBlueGreen })
    hl(0, 'CmpItemKindConstant', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, 'CmpItemKindStruct', { fg = c.vscViolet })
    hl(0, 'CmpItemKindTypeParameter', { fg = c.vscViolet })
